...
import verifyGoogleIdToken from "../framework/utils/googleVerification";
...
export class UserUseCase implements IUserUseCase {
  ...
  async execute(
    ...
    try {
      const tokenPayload = await verifyGoogleIdToken(token);
      ...
      if (!existingUser) {
        ...
        // Return a success message for newly created users
